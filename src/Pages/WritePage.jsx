...
export default function WritePage() {
  ...
  return (
    <div>
      <div className="w-full flex justify-between  items-center bg-sky-40">
        <div className=" flex gap-2 py-4 items-center lg:ml-40 ml-4 ">
          <svg
          onClick={LogoClick}
            className="w-32"
        ...
        <div className=" flex gap-4 items-center lg:mr-40  mr-4 w-auto">
          <button
            disabled={!Value}
            className={`py-1 px-2 rounded-full text-[14px] text-white outline-none 
        ${Value ? "bg-[#408919]" : "bg-gray-400 cursor-not-allowed"}`}
          >
            Publish
          </button>
          <svg
            ...
            fill="none"
            viewBox="0 0 24 24"
            className="text-[#6b6b6b] hover:text-black cursor-pointer lg:flex md:flex hidden"
          >
            <path
              fill="currentColor"
              fill-rule="evenodd"
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="text-[#6B6B6B] lg:flex md:flex hidden"
            width="24"
            height="24"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div className=" lg:w-[70%] w-full lg:ml-[20%]  ml-4 mt-8">
        <div className="flex items-center">
          <svg
            className="border-black border-[1px] rounded-full py-1 px-1 "
            width="35"
            height="35"
          >
            <path
          ...
          <div>
            <input
              type="text"
              className="px-6 outline-none font-Source text-[18px]"
              value={Value}
