...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className="w-full h-14 flex justify-between"
        style={{ borderBottom: "solid 1px #f0ebeb" }}
      >
        {/* LogoAndSearch */}
        <div className="lg:w-[30%] md:w-[50%] flex items-center ml-2 justify-around">
          <span className="w-28 ml-4 cursor-pointer">
            <svg
              onClick={LogoClick}
          ...
          <div className="w-64 h-[75%] rounded-full lg:flex md:flex items-center bg-[#F9F9F9] hidden ml-2">
            <span className="w-26 px-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {fouces && value && (
            <div className="w-[20%] bg-white shadow-md absolute top-[10%] left-40">
              <p className="font-SohneNormal py-3 px-2">{value}</p>
            </div>
          )}
        </div>

        <div className="lg:w-52 w-40 flex items-center justify-around mr-4">
          ...
          <div onClick={WritePgae} className="lg:flex hidden cursor-pointer items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="text-[#6B6B6B]"
              width="24"
            ...
            <span className="ml-2 text-[#6B6B6B] text-[13px] font-SohneNormal">
              Write
            </span>
          </div>
          ...
          <span className="bg-[#6C818D] rounded-full w-[32px] py-1 h-[32px] text-white text-center">
            N
          </span>
        </div>
      </nav>
